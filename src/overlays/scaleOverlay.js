...
DICOM.Overlays.ScaleOverlay.prototype.refreshScaleRuler = function(){
    ...
    var self = this;
    var pixelspacingX = Number(this.pane.imageWrapper.tags.PixelSpacing.value[0]);
    var pixelspacingY = Number(this.pane.imageWrapper.tags.PixelSpacing.value[1]);
    ...
    geometry.vertices.push(
        new THREE.Vector3( tenMM, bottomPos, 0 ),
        new THREE.Vector3(  -tenMM,bottomPos, 0 )
    );
    ...
    tickGeometry.vertices.push(
        new THREE.Vector3( 0,bottomPos,0),
        new THREE.Vector3( 0,bottomPos2,0)
    )
    ...
    tickGeometry1.vertices.push(
        new THREE.Vector3( tenMM,bottomPos,0),
        new THREE.Vector3( tenMM,bottomPos2,0)
    )
